      ...
      <div className="container">
        ...
        <div className="article-content mx-auto max-w-[48.125rem]">
          ...
          <h2>Ownership</h2>
            ...
            NFT-Style logo and all designs, text, graphics, pictures, data,
            software, sound files, other files, and the selection and
            arrangement thereof are the proprietary property of NFT-Style or our
          ...
          <h2>Miscellaneous</h2>
            ...
            assigned by you without the prior written consent of NFT-Style, and
            NFT-Style’s failure to assert any right or provision under these
