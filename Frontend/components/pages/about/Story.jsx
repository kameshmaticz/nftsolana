...
export default function Story() {
  ...
  const GetAboutMiddle = async () => {
    var resp = await getCmsContent("aboutus_middle");
    console.log("aboutus_middle", resp.data)
    if (resp?.status) setAboutmiddle(resp.data);
  };
    ...
    <section className="relative py-24 dark:bg-jacarta-800">
      <picture className="pointer-events-none absolute inset-0 -z-10 dark:hidden">
        <Image
          ...
          // src={`${config.IMG_URL}/cmsimg/${Aboutmiddle?.img}`}
          alt="gradient"
        ...
        <div className="lg:flex lg:justify-between">
          ...
          <div className="py-20 lg:w-[45%] lg:pl-16">
            ...
            <div className="mb-10 dark:text-jacarta-300">
              ...
              <div dangerouslySetInnerHTML={{ __html: Aboutmiddle?.answer }}></div>
            </div>
